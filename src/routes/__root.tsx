...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Content Plan Preview for PayWise" },
      {
        name: "description",
        content:
          "PayWise Preview is an interactive landing page showcasing client content previews.",
      },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Content Plan Preview for PayWise" },
      {
      ...
      { name: "twitter:title", content: "Content Plan Preview for PayWise" },
      {
